module Customer
  class WalletController < BaseController
    ...
    def index
      ...
      # Show the whole catalog (including not-yet-open / out-of-window rewards),
      # open ones first, ended ones last; the card + reward page gate redemption.
      state_order = { open: 0, upcoming: 1, closed: 2, out_of_stock: 3, ended: 4, inactive: 5 }
